...
2. Run using predefined settings or other custom command. For example, predefined in a `Makefile` or a `justfile`. If the user wants a customa command, suggest at lleast one for the user.
