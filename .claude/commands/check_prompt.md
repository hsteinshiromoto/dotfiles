...
8. **Prefilling Strategy**
   ...
   - Guides output format (e.g., starting with `{` for JSON)
...
1. [Most critical improvement]. For example, impacts most of the usage.
2. [Second priority]. For example, impacts the single most important part of the usage.
3. [Third priority]. For example, impacts a few less important poarts of the usage.
...
- Apply inappropriate criteria (e.g., multishot for simple tasks)
- Miss obvious issues
...
2. In the user message, provide: "Assess this prompt: [paste prompt here]"
3. Receive structured assessment tables with specific improvements
